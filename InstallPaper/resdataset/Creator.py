...
class Creator(object):
    ...
    def wikiNetworkx(self, Data):
        ...
        # nx.write_graphml(self.wikiGraph, "../Dataset/WikiGraph.graphml")
    ...
    def random_node(self):  
        f = open('../Dataset/random_node.txt', 'a+')   
        random_list = []
        for i in range (0, 10):
            rdNodes = random.choice(list(self.wikiGraph.nodes))
            random_list.append(rdNodes)
        print random_list
